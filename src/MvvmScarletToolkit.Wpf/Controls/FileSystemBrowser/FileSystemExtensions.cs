...
namespace MvvmScarletToolkit
{
    ...
    {
        public static IEnumerable<IFileSystemInfo> GetChildren(this ScarletFileSystemContainerBase directory, IScarletCommandBuilder commandBuilder)
        {
        ...
        private static IEnumerable<IFileSystemInfo> GetDirectories(string path, IFileSystemDirectory parent, IScarletCommandBuilder commandBuilder)
        {
            try
            {
        ...
        private static IEnumerable<IFileSystemInfo> GetFiles(string path, IFileSystemDirectory parent, IScarletCommandBuilder commandBuilder)
        {
            try
            {
