...
namespace MvvmScarletToolkit
{
    ...
    public static class ListExtensions
    {
        ...
        public static void UpdateItems<T1, T2>(this IList<T1> targetCollection, IList<T2> updateCollection, Func<T1, T2, bool> comparer, Func<T2, T1> mapper, Action<T1, T2> updater)
        {
            UpdateItems(targetCollection, updateCollection, comparer, mapper, updater, _ => true, _ => false);
        }

        public static void UpdateItems<T1, T2>(this IList<T1> targetCollection, IList<T2> updateCollection, Func<T1, T2, bool> comparer, Func<T2, T1> mapper, Action<T1, T2> updater, Func<T1, bool> targetFilter)
        {
        ...
        private static void AddNewItemsToTarget<T1, T2>(IList<T1> targetCollection, IList<T2> updateCollection, Func<T1, T2, bool> comparer, Func<T2, T1> mapper)
        {
